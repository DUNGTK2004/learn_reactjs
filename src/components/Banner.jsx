...
const Banner = () => {
  return (
    <div className="w-full h-[600px] bg-banner bg-center bg-cover relative">
        ...
        <div className="flex flex-col space-y-5 items-baseline w-[50%]">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-white">
              ...
              quidem quia deleniti beatae laudantium maiores, natus harum sequi
              reiciendis nobis, impedit et modi quod fuga vitae, facere
              molestiae cum iure?
            </p>
